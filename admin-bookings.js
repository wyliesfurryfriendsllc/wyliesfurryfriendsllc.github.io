    ...
    items.forEach(({ b, slotStr, key, adminTime, slotStart }) => {
        ...
        const avatarHtml = allPets.length
            ? allPets.map(p => p.photoUrl
                ...
                : `<div class="abc-pet-avatar abc-pet-emoji">${petIcon(p.type)}</div>`
              ).join('')
            : `<div class="abc-pet-avatar abc-pet-emoji">${PET_ICON_DOG}</div>`;
            ...
            card.innerHTML = `
                <div class="abc-layout">
                    ...
                    <div class="abc-right">
                        ...
                        <div class="abc-price">${b.finalTotal != null ? `$${b.finalTotal}` : `$${calcBaseTotal(b) || b.total || 0}`}</div>
                    </div>
                </div>`;
    ...
    return `<div class="payment-record">
        ${hasDeposit ? `<div class="payment-record-row">
            ...
            <div class="payment-record-right">
                <span class="payment-record-val">${b.depositAmount != null ? '$' + b.depositAmount : '—'} · ${b.depositDate || '—'}${b.depositMethod ? ' · ' + b.depositMethod : ''}</span>
        ...
        ${hasFinal ? `<div class="payment-record-row">
            ...
            <div class="payment-record-right">
                <span class="payment-record-val">${b.finalPaymentAmount != null ? '$' + b.finalPaymentAmount : '—'} · ${b.finalPaymentDate || '—'}${b.finalPaymentMethod ? ' · ' + b.finalPaymentMethod : ''}</span>
